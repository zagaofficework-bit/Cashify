...
import {smartwatchFilterData} from "../../../res/Data/SearchFilter";

const FindNewSmartwatch = () => {
    const videos = [
    {
  ...
  return (
    <div>
        <NavMenu/>
      <SlidingAnimations/>
      <SearchByModel data={smartwatchFilterData} category='smartwatches'/>
      <Recents/>
...
export default FindNewSmartwatch