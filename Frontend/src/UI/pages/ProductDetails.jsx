...
export default function RefurbishedPhoneCard() {
  ...
  return (
    <>
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-red-600 font-bold text-xl">
                -63% ₹34,599{" "}
                <span className="line-through text-gray-400">₹94,499</span>
              </p>
              <p className="text-sm text-gray-600">
                Get it for <span className="font-semibold">₹33,999</span> with
                GOLD
              </p>
              <p className="text-sm text-gray-600">
        ...
        <div className="max-w-5xl mx-auto p-6 space-y-8">
          ...
          <div>
            ...
            <ul>
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Overall</strong> – No functional defects
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-600 font-bold">✔</span>
                <span>
                  <strong>Screen Glass</strong> – Minimal scratches, barely
                  noticeable when screen is off
                  <li />
                  <li>
                    <img
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-600 font-bold">✔</span>
                <span>
                  <strong>Display</strong> – Perfect condition
                </span>
              </li>
              <li>
                <img
          ...
          <div>
            ...
            <p className="text-sm text-gray-700 mb-4">
              ✔ <strong>Chrome/Body</strong> – Minor signs of wear and light
              scratches. Invisible from a 20 cm distance.
            </p>
      ...
      <RatingReviews />
      <img
        src="./assets/img/NewVsRefurbished.png"
