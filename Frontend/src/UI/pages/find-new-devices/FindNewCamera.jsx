...
import { camerasFilterData } from "../../../res/Data/SearchFilter";
...
const FindNewCamera = () => {
  ...
  return (
    <div>
      ...
      {/*
        ✅ Pass category="cameras" so SearchByModel encodes ?cat=cameras in the URL.
           SearchPage reads this and uses the cameras data maps — not laptops.
      */}
      <SearchByModel
