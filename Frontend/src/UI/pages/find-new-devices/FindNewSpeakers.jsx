...
import {speakersFilterData} from "../../../res/Data/SearchFilter";

const FindNewSpeakers = () => {
    const videos = [
    {
  ...
  return (
    <div>
        <NavMenu/>
      <SlidingAnimations/>
      <SearchByModel data={speakersFilterData} category='speakers'/>
      <Recents/>
...
export default FindNewSpeakers
