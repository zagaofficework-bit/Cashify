...
import { stores } from "../../res/js/store.js";
...
const StoreSection = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-6">
      ...
      <div className="flex gap-8 text-sm mb-6"> <div className="flex items-center gap-3"> 📍
        <span className="font-medium">200+ Experience Centres</span>
      </div> <div className="flex items-center gap-2"> ⭐
          <span className="font-medium">4.5+ Star Ratings</span>
        </div> </div>
      <div className="bg-gray-100 max-w-7xl mx-auto px-6 py-6 rounded-xl"> {/* Search */} <div className="mb-6"> <div className="flex items-center bg-white rounded-lg shadow-sm w-[300px] px-3 py-2"> <input type="text" placeholder="Enter Pincode" className="flex-1 outline-none text-sm" />
