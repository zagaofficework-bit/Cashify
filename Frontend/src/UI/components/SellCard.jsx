...
export default function SellCard({title}) {
  return (
    ...
    <>
    <section className="bg-gray-200 rounded text-black px-6 py-12 ">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 mb-15">
