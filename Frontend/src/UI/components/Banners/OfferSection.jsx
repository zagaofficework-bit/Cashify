    ...
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="flex items-center gap-5 bg-purple-100 border-2 border-purple-300 rounded-xl p-5">
          <img src="../assets/phone.png" alt="phone" className="w-28" />
          ...
          <div>
            ...
            <p className="text-sm mt-1">
              ₹58,699{" "}
              <span className="line-through text-gray-500">₹1,19,799</span>
            </p>

            <p className="text-gray-500 text-xs">Effective Price</p>

            <p className="text-2xl font-bold">₹57,525</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-5 bg-purple-100 border-2 border-purple-300 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-sm mt-1">
              ₹68,699{" "}
              <span className="line-through text-gray-500">₹1,18,899</span>
            </p>

            <p className="text-gray-500 text-xs">Effective Price</p>

            <p className="text-2xl font-bold">₹67,325</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-5 bg-purple-100 border-2 border-purple-300 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-sm mt-1">
              ₹18,899{" "}
              <span className="line-through text-gray-500">₹54,499</span>
            </p>

            <p className="text-gray-500 text-xs">Effective Price</p>

            <p className="text-2xl font-bold">₹18,521</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-black text-white flex items-center justify-between px-6 py-4 rounded-lg">
        ...
        <p className="hidden md:block">
          Explore select range of{" "}
          <span className="font-semibold">Google-trusted</span> Pixel phones
        </p>
