...
export default function NavBar() {
      ...
      {pincodeCity && (
        <div className="mt-3 flex items-center justify-between bg-teal-50 border border-teal-200 rounded-lg px-3 py-2">
          <div>
            ...
            <p className="text-sm font-semibold text-teal-700">{pincodeCity}</p>
          </div>
          <button
  ...
  return (
    <div>
      <nav className="fixed top-0 w-full bg-white  px-4 md:px-6 z-100 py-3">
        <div className="flex items-center justify-between gap-3">
          {/* Logo */}
          <img
            src="./assets/img/Phonify1.png"
            onClick={() => navigate("/")}
            alt="Phonify Logo"
            className="h-10 w-auto cursor-pointer flex-shrink-0 object-contain"
          />
